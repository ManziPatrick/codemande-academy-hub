        ...
        >
          ...
          <div className="mt-8 p-4 bg-muted/50 rounded-lg border border-border">
            ...
            <div className="space-y-1 text-xs text-muted-foreground">
              <p><span className="font-medium">Student:</span> student@codemande.com / student123</p>
              <p><span className="font-medium">Trainer:</span> trainer@codemande.com / trainer123</p>
              <p><span className="font-medium">Admin:</span> admin@codemande.com / admin123</p>
            </div>
          </div>
